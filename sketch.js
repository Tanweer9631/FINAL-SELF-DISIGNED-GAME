...
var database, gameState, bikeDiedSound;
var form, player, playerCount, bikeSound, gameStartSound;
...
function preload() {
  ...
  bikeSound = loadSound("assets/bikesound.mp3");
  bikeDiedSound = loadSound ("assets/bikedied.mp3");
